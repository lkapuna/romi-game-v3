...
const TOPICS = ["חתול","בית","עץ","שעון","בננה","חורף","גלידה","ילדה","דובי","עננים","קשת בענן","מכונית","שמש","דג","ציפור","פרח","כוכב","רובוט","עוגה","טלפון","בלון","ירח","הר","פרפר","ספינה","מטוס","דינוזאור","גשר","כלב","סוס","צב","פיל","אבטיח","כריש","מגלשה","ארנב","פרה","אריה"];
const DRAW_TIME = 60;
const MAX_ROUNDS = 5;
